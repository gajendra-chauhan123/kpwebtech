...
;(function( $ ) {
  ...
  var Validetta = {}, // Plugin Class
	...
	//RegExp for input integer control method
    RINTEGER = new RegExp( /^[0-9]*$/ ),
	//RegExp for input alphabatic control method
    RALPHABET = new RegExp( /^[a-zA-Z ]*$/ ),
	//RegExp for input alpha-numeric control method
    RALPHANUMERIC = new RegExp( /^[a-zA-Z0-9 ]*$/ ),
	//RegExp for input Pan Card Number control method
    RPANCARD = new RegExp( /^([a-zA-Z]{5})(\d{4})([a-zA-Z]{1})*$/ ),
  ...
  messages = {
    ...
    email     : 'E-mail Id appears to be invalid.',
    number    : 'You can enter only numbers in this field.',
	integer    : 'You can enter only integers in this field.',
	alphabet	: 'Only alphabates allowed.',
	alphaNumeric	: 'Only alphanumeric value allowed.',
	...
	panCard		: 'Invalid PAN Card number. Please be sure to check.'
  },
  ...
  Validator = {
	...
	// Integer check
    integer : function( tmp ) {
      return RINTEGER.test( tmp.val ) || messages.integer;
    },
	// Alphabet check
    alphabet : function( tmp ) {
      return RALPHABET.test( tmp.val ) || messages.alphabet;
    },
	// Alpha Numeric check
    alphaNumeric : function( tmp ) {
      return RALPHANUMERIC.test( tmp.val ) || messages.alphaNumeric;
    },
    ...
    panCard : function( tmp ) {
      return RPANCARD.test( tmp.val ) || messages.panCard;
    },
    //Checkbox check
